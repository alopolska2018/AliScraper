...
class SyncDbWoocommerce():
    ...
    def __init__(self):
        ...
        self.wcapi = API(
            url="http://93.104.210.240/nowy/wordpress",
            consumer_key="ck_21ad21d1bac02e0abacdac7db56cf0cfe98267d3",
            consumer_secret="cs_2f17a73fb6f528a01a417e68580a44a769ad9fbd",
            wp_api=True,
            version="wc/v3"
        )
        self.run()
    ...
    def check_unadded_products_in_woocommerce(self):
        ...
        for product in unadded_products:
            ...
            response = self.create_main_product_woo(name, regular_price, description)
